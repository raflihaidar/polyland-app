  ...
  <MobileLayout>
    <section class="px-2 py-6 space-y-6">
      ...
      <div>
        ...
        <ol
          class="list-decimal pl-5 space-y-2 text-sm leading-relaxed text-gray-700 text-justify"
        >
          <li>
          ...
          <li>
            Fotokopi KTP dari para pihak penjual–pembeli dan/atau kuasanya
          </li>
          <li>
          ...
          <li>Fotokopi SPPT dan PBB tahun berjalan serta bukti SSB (BPHTB)</li>
        </ol>
      </div>
        ...
        <div class="space-y-4">
          ...
          <template v-else>
            <RouterLink
              ...
              :key="index"
              :to="`/peralihan-hak/form?officeId=${item.id}`"
              class="block p-3 hover:bg-slate-100 transition-colors"
            >
